...
- **Correo de contacto:** `[POR DEFINIR]` la dirección exacta que se publica. Es un dato operativo, no una decisión pendiente: la decisión de fondo ya está tomada, falta escoger el buzón que Santiago va a atender. Sin él, el aviso de privacidad no se puede publicar.
...
- **El hecho, sin adornos:** el piloto corre sobre Claude Code en un canal de Telegram, sin servidor propio. El procesamiento ocurre **fuera de Colombia**, y eso activa el art. 26 de la Ley 1581, que prohíbe la transferencia a países que no acrediten nivel adecuado de protección.
