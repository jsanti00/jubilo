...
- **Tabla de coeficientes de presunción de costos por actividad CIIU (Resolución UGPP 532 de 2024).** Es lo que falta para dar el porcentaje de costos de un rentista o de cualquier independiente. La resolución está publicada en `ugpp.gov.co`, pero **esa página no expone el anexo**, y el articulado solo se consiguió en la compilación de la Secretaría Jurídica Distrital. **Se cierra pidiéndosela a la UGPP por su portal de transparencia o por derecho de petición**, no con un abogado. Cierra dos marcas de un solo golpe: el coeficiente de rentistas, hoy en 28,08% por fuentes secundarias convergentes, y si ese coeficiente cubre o no los dividendos y participaciones (`rentista-de-capital.md` s.5 y s.6).
